...
import TBC from "../../../assets/images/TBC logo.png"
import "./Header.css"
function Header() {
    return (
        <>
            <header>
                <nav className="flex">
                    ...
                    <ul className="flex navigation-container">
                        <li>
                            <NavLink to="/" className="underline">პროდუქტები</NavLink>
                        </li>
                        <li>
                            <NavLink to="/" className="underline">შეთავაზებები</NavLink>
                        </li>
                        <li>
                            <NavLink to="/" className="underline">კონცეპტის სივრცე</NavLink>
                        </li>
                    </ul>
                    <ul className="flex">
                        <li><NavLink to="/">
                        ...
                        <li className="select-set"><NavLink to="/">
                        ...
                        <li className="language-switch flex">
