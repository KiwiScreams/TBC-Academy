...
function Header() {
    return (
        <>
            <header className="w-full bg-white fixed top-0 left-0 right-0 h-20 border-b border-solid border-gray-300">
                <nav className="flex justify-between items-center w-9/12 m-auto">
                    ...
                    <ul className="flex justify-between items-center gap-4">
                        ...
                        <li className="font-bold flex justify-between items-center text-base text-gray-700">
