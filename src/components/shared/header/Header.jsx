...
function Header() {
    return (
        <>
            <header className="w-full bg-white fixed top-0 left-0 right-0 h-20 border-b border-solid border-gray-300 z-10">
                <nav className="flex justify-between items-center w-9/12 m-auto">
                    ...
                    <ul className="flex justify-between items-center gap-10">
                        <li className="und-line relative h-20 flex justify-center items-center">
                            <NavLink to="/">პროდუქტები</NavLink>
                        </li>
                        <li className="und-line relative h-20 flex justify-center items-center">
                            <NavLink to="/">შეთავაზებები</NavLink>
                        </li>
                        <li className="und-line relative h-20 flex justify-center items-center">
                            <NavLink to="/">კონცეპტის სივრცე</NavLink>
                        </li>
                    </ul>
                    <ul className="flex justify-between items-center gap-4">
                        ...
                        <li className="font-bold flex justify-between items-center text-base p-2 rounded-md text-gray-700 hover:bg-gray-200">
